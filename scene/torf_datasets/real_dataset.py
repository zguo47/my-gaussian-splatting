...
class RealDataset(ToFDataset):
    def __init__(
        self,
        args,
        file_endings={"tof": "npy", "color": "npy", "depth": "npy", "cams": "mat"},
    ):
    ...
    def _process_camera_params(self, args):
        ...
        # Relative pose
        relative_R_path = os.path.join(args.source_path, f"cams/relative_R.mat")
        relative_T_path = os.path.join(args.source_path, f"cams/relative_T.mat")
        ...
        # Phase offset
        phase_offset_path = os.path.join(args.source_path, f"cams/phase_offset.mat")
        ...
        # Depth range
        depth_range_path = os.path.join(args.source_path, f"cams/depth_range.mat")
